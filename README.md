# Вариант 10
## 10.	Сортировка прямым выбором; Сортировка Шелла
Произвести анализ сортировок массивов в соответствии с вариантом, выданным преподавателем. Для чего отсортировать по неубыванию  массивы целочисленных элементов  различной размерности: 10 элементов, 100 элементов, 2000 элементов. Анализ произвести по числу сравнений и числу обменов двух элементов. Исследования производить над массивами двух типов:
![Image alt](https://github.com/Butonsusumom/Laba5/blob/master/Capture.PNG)
